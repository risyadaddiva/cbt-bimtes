...
import { Newspaper, Images, BookOpen, Monitor, CheckCircle, Heart, Lightbulb, Shield } from 'lucide-react';
      ...
      <section className="py-16 bg-gray-50">
        <div className="site-container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 font-[family:var(--font-heading)]">Akses Cepat</h2>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/berita" className="group block card-hover bg-white rounded-xl p-6 border shadow-sm flex flex-col items-center text-center">
            ...
            <Link href="/galeri" className="group block card-hover bg-white rounded-xl p-6 border shadow-sm flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Galeri Kegiatan</h3>
              <p className="text-sm text-gray-500 mb-4 flex-1">Dokumentasi momen berharga dari berbagai kegiatan organisasi.</p>
              <span className="text-indigo-600 font-semibold text-sm group-hover:underline flex items-center">Lihat <span className="ml-1">→</span></span>
            </Link>

            <Link href="/landasan-hukum" className="group block card-hover bg-white rounded-xl p-6 border shadow-sm flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Landasan Hukum</h3>
              <p className="text-sm text-gray-500 mb-4 flex-1">Akses dokumen konstitusi, AD/ART, dan pedoman organisasi PMII.</p>
              <span className="text-purple-600 font-semibold text-sm group-hover:underline flex items-center">Lihat <span className="ml-1">→</span></span>
            </Link>

            <Link href="/login" className="group block card-hover bg-white rounded-xl p-6 border shadow-sm flex flex-col items-center text-center ring-2 ring-pmii-gold/20">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">CBT BIMTES 2026</h3>
              <p className="text-sm text-gray-500 mb-4 flex-1">Platform ujian masuk tryout dan bimbingan tes PMII UIN SGD.</p>
              <span className="text-pmii-gold font-semibold text-sm group-hover:underline flex items-center">Akses Platform <span className="ml-1">→</span></span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section id="tentang-kami" className="py-20 bg-white">
        <div className="site-container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="ribbon-label mb-4 inline-block">Tentang Kami</span>
              ...
              <div className="text-gray-600 space-y-4 mb-8 text-lg leading-relaxed">
                <p>
                  Pergerakan Mahasiswa Islam Indonesia (PMII) adalah organisasi kemahasiswaan yang berlandaskan Islam Ahlussunnah wal Jama'ah. Berdiri pada 17 April 1960 di Surabaya.
                </p>
                <p>
                  PMII Komisariat UIN Sunan Gunung Djati Bandung merupakan wadah pergerakan dan kaderisasi mahasiswa dalam mengembangkan potensi intelektual, spiritual, dan sosial untuk mewujudkan kemajuan bangsa.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg border flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Kesadaran spiritual kepada Allah SWT.</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Pengembangan intelektual dan analisis kritis.</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg border flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Implementasi nyata untuk umat dan bangsa.</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="site-container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {latestNews.length > 0 ? (
              latestNews.map((news) => (
                <Link key={news.id} href={`/berita/${news.slug}`} className="group bg-white rounded-xl overflow-hidden border shadow-sm card-hover flex flex-col h-full">
                  <div className="relative h-48 overflow-hidden bg-gray-200">
                    <img 
                      src={news.coverImage ? getDriveDisplayUrl(news.coverImage) : PLACEHOLDER_IMAGE} 
                      alt={news.title}
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="text-xs text-gray-500 mb-2 font-medium">
                      {news.publishedAt ? format(new Date(news.publishedAt), 'd MMMM yyyy', { locale: id }) : ''}
                    </div>
              ...
              Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="bg-white rounded-xl overflow-hidden border shadow-sm flex flex-col h-full opacity-70">
      ...
      <section className="bg-pmii-blue py-16 md:py-24">
        <div className="site-container mx-auto px-4 text-center">
          <p className="text-2xl md:text-4xl lg:text-5xl font-[family:var(--font-heading)] font-bold italic text-white leading-tight max-w-4xl mx-auto drop-shadow-sm">
            "Terlahir dari Rahim Kampus, <br className="hidden md:block"/> Tumbuh Bersama Umat"
          </p>
